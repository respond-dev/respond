import { ReplacementInputType } from "libs/fs/fileCopier"
...
export function promiseAllImport(): string {
  return 'import promiseAll from "libs/respond/promiseAll"'
}
...
export function styleInjectorImport(): string {
  return 'import styleInjector from "libs/respond/styleInjector"'
}
